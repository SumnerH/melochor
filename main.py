...
from constants import RARITY_INTERVAL, COLORS, COLOR_LIST, NEON_PALETTE, TRANQUIL_PALETTE, METAL_PALETTE
from constants import SUPPORTED_ROUTINES
...
from shaders import SKY_VERTEX_SHADER, SKY_FRAGMENT_SHADER, LINE_VERTEX_SHADER, LINE_FRAGMENT_SHADER, PARTICLE_VERTEX_SHADER, PARTICLE_FRAGMENT_SHADER
from shaders import create_program, compile_shader
